...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home); // Your main layout XML file
        ...
        furnitureList.add(new Furniture("Modern Chair", "Rs: 20,000", "5.0", R.drawable.item4));


        furnitureAdapter = new FurnitureAdapter(this, furnitureList);
        productsRecyclerView.setAdapter(furnitureAdapter);

        //Example on how to set the text color programatically
        //TextView  textView = findViewById(R.id.category_id);
